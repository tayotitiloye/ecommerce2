...
function Hero() {
    return (
        ...
        >
            <div className="flex flex-col flex-1 mt-7 lg:mt-3 gap-5  md:px-20 lg:p-4  h-1/2 lg:h-screen box-border">
            {/* <div className="flex flex-col flex-1 mt-7 lg:mt-3 gap-5  md:px-20 lg:p-4  h-1/2 lg:h-screen box-border"> */}
            ...
            <div className="hidden lg:block flex-1 relative">
              ...
              <Image src="https://fakestoreapi.com/img/71YAIFU48IL._AC_UL640_QL65_ML3_.jpg" alt='image' width={150} height={150} className='absolute object-contain bottom-[150px] left-[100px] z-10 -rotate-[30deg] mr-2'/>  
                
              <Image src="https://fakestoreapi.com/img/71YXzeOuslL._AC_UY879_.jpg" alt='image' width={150} height={150} className='absolute bottom-[150px] right-[120px] z-10 object-contain rotate-[30deg] ml-2'/>  
