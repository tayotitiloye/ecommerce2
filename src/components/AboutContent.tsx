         ...
         <div className='bg-orange-100 px-4 text-yellow-900 my-8 h-32 flex items-center justify-start text-2xl md:6xl font-bold '>
            ...
            <div className='lg:flex flex-row'>
                <motion.div
                    ...
                    <Image src='/friends.avif' alt='image' fill className='object-cover mb-10 p-4 md:p-7'/>
                </motion.div>
                <motion.div
                    variants={slideInFromRight(.8)}
                    className='lg:flex-1'>
                    <h1 className='text-3xl lg:text-5xl mb-8 font-bold my-5  px-4'>Our Story</h1>
                    <div className=' my-5 px-4 leading-10 md:px-32 lg:px-4 text-sm md:xl text-md tracking-wider'>
